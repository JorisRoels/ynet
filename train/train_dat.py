"""
    This is a script that trains a U-Net in a domain adaptive way by regularizing the final feature layer with domain
    confusion.
"""
...
parser.add_argument("--log_dir", help="Logging directory", type=str, default="unet_dat")
...
parser.add_argument('--lambda_dc', help='Regularization parameter for the domain confusion', type=float, default=1e-1)
...
net = UNetDAT2D(feature_maps=args.fm, levels=args.levels, norm=args.norm, lambda_dc=args.lambda_dc,
                activation=args.activation, coi=args.classes_of_interest, dropout=args.dropout,

"""
    This is a script that trains a U-Net in a domain adaptive way by regularizing the final feature layer with maximum
    mean discrepancy.
"""
...
parser.add_argument("--log_dir", help="Logging directory", type=str, default="unet_mmd")
...
net = UNetMMD2D(feature_maps=args.fm, levels=args.levels, norm=args.norm, lambda_mmd=args.lambda_mmd,
